 ...
 *
 * sha256.rs — Self-contained, dependency-free FIPS 180-4 SHA-256 cryptographic hasher.
 *             Provides deterministic, allocation-minimal digest calculation for
 *             MahinaOS generation manifests and boot state commits.
 */
...
mod tests {
    ...
    fn test_sha256_empty_string() {
        ...
        assert_eq!(Sha256::digest_hex(b""), expected);
    }

    #[test]
    fn test_sha256_abc() {
        let expected = "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad";
        assert_eq!(Sha256::digest_hex(b"abc"), expected);
    }
